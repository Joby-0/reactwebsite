  ...
  return (
      ...
      <footer className="row py-5 my-5 border-top row-cols-1 row-cols-sm-2 row-cols-md-5">
        ...
        <div id="footerOrder3" className="col col-md-2 mb-3">
          <h5>Categories</h5>
          <ul className="nav flex-column">
            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">Sport</a></li>
            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">Computer</a></li>
            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">Phones</a></li>
            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">Vehicles</a></li>
        ...
        <div id="footerOrder4" className="col col-md-2 mb-3">
          ...
          <ul className="nav flex-column">
            ...
            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">Privacy Settings</a></li>
            <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">Pricing</a></li>
          </ul>
        </div>
