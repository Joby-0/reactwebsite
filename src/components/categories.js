        ...
        <div className="container text-center">
            ...
            <div className="row g-3 justify-content-center">
                <div className="col-auto">
                    <a className="icon-link d-block btn rounded-pill py-1 icon-link-hover" style={{ '--bs-icon-link-transform': 'translate3d(0, -.125rem, 0)' }} href="#">
